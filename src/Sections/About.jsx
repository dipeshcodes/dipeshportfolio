    ...
    <section className="c-space section-spacing" id="about">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-6 md:auto-rows-[18rem] mt-12">
        ...
        <div className="flex items-end grid-default-color grid-1">
          ...
          />
          <div className="z-10">
            <p className="headtext">Hi, I'm Dipesh Kumar</p>
            <p className="subtext">
        ...
        <div className="grid-default-color grid-2">
          ...
          >
            <p className="flex items-end text-5xl text-gray-500">CODE SPEAKS</p>
            <Card
        ...
        <div className="grid-black-color grid-3">
          <div className="z-10 w-[50%]">
            ...
            <p className="subtext">
              I'm based in Pune, and open to remote work worldwide or shift to
              Mars.
            </p>
          </div>
        ...
        <div className="grid-default-color grid-5">
          <div className="z-10 w-[50%]">
            ...
            <p className="subtext">
              I specialize in a variety of languages, frameworks, databases and
